...
RUN comfy model download --relative-path models/loras --filename wan2.2_i2v_A14b_low_noise_lora_rank64_lightx2v_4step_1022.safetensors --url "https://civitai.com/api/download/models/2337903?type=Model&format=SafeTensor"
